...
namespace PanoProxy
{
    public class BasicAuthFilter : IEndpointFilter
    {
        ...
        public async ValueTask<object?> InvokeAsync(EndpointFilterInvocationContext context, EndpointFilterDelegate next)
        {
            ...
            {
                httpContext.Response.Headers["WWW-Authenticate"] = "Basic realm=\"PanoProxy\"";
            ...
            var configUsername = _config["BasicAuth:Username"];
            var configPassword = _config["BasicAuth:Password"];
